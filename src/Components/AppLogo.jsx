  ...
  return (
    <div className={`flex flex-wrap items-center justify-center gap-3 sm:gap-4 ${className}`}>
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.96 }}
        className="inline-flex items-center space-x-3 bg-black text-white px-4 sm:px-5 py-2.5 rounded-2xl border border-white/10 shadow-md hover:shadow-xl transition-all cursor-pointer select-none"
      >
        <svg className="w-6 h-6 shrink-0 rounded-[5px]" xmlSpace="preserve" viewBox="0 0 800 800">
        ...
        <div className="text-left flex flex-col leading-none">
          <span className="text-[10px] text-gray-300 font-normal tracking-wide">Coming Soon on</span>
          <span className="text-xs sm:text-sm font-semibold tracking-tight mt-1">App Store</span>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="inline-flex items-center space-x-3 bg-black text-white px-4 sm:px-5 py-2.5 rounded-2xl border border-white/10 shadow-md hover:shadow-xl transition-all cursor-pointer select-none"
      >
        <svg className="w-5 h-5 shrink-0" fillRule="evenodd" clipRule="evenodd" imageRendering="optimizeQuality" shapeRendering="geometricPrecision" textRendering="geometricPrecision" viewBox="0 0 466 511.98">
          <g fillRule="nonzero">
        ...
        <div className="text-left flex flex-col leading-none">
          <span className="text-[10px] text-gray-300 font-normal tracking-wide">Coming Soon on</span>
          <span className="text-xs sm:text-sm font-semibold tracking-tight mt-1">Google Play</span>
        </div>
      </motion.div>
    </div>
  );
