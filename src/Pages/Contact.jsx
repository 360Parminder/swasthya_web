      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-[#fafafa] rounded-3xl p-8 border border-gray-100 space-y-6">
              <h2 className="text-xl font-bold text-gray-900">Direct Channels</h2>
              ...
              <div className="space-y-5">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-800">360.parminder@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-800">+91 8779112732</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-800">Alwar, Rajasthan, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-800">Mon - Fri: 9:00 AM - 6:00 PM IST</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Quick FAQ Card */}
            <div className="bg-[#fafafa] rounded-3xl p-6 border border-gray-100 space-y-3">
              <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wide">Quick FAQ</h3>
            ...
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12 space-y-4">
                ...
                <button
                  ...
                  className="mt-4 text-xs font-semibold text-brand-500 hover:underline"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-white text-gray-900 border border-gray-200 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 focus:outline-none text-sm transition-all"
                      required
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-brand-500 hover:bg-brand-600 text-white font-semibold py-3 px-6 rounded-xl shadow-md shadow-brand-500/25 active:scale-95 transition-all duration-200 text-sm"
                  >
                    Send Message
                  </button>
                </form>
